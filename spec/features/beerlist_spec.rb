...
describe "beerlist page" do
  ...
  it "is by default sorted by name", js:true do
    visit beerlist_path
  ...
  it "is sorted by brewery when brewery is clicked", js:true do
    visit beerlist_path
    click_link 'Brewery'
  ...
  it "is sorted by style when style is clicked", js:true do
    visit beerlist_path
    click_link 'Style'
